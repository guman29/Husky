// Simple PetPal logo: a paw print on a gold badge, replacing the generic
...
function Logo({ size = 28 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" role="img" aria-label="PetPal logo">
      <defs>
        <linearGradient id="petpal-logo-gradient" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#c68a3a" />
          <stop offset="100%" stopColor="#936923" />
        </linearGradient>
      </defs>
      <circle cx="24" cy="24" r="22" fill="url(#petpal-logo-gradient)" />
      <g fill="#fffaf2">
